    ...
    <div className="container max-w-[1200px]  -pb-5">
      {(index === 0 || index === 1 || index === 3 || index === 2) && (
        <motion.div className={`w-full flex overflow-hidden relative px-10 py-2 items-center justify-center ${index === 1 || index === 3 ? 'md:flex-row-reverse' : 'md:flex-row'} flex-col flex-wrap md:gap-4  items-center`}
          ...
          <motion.div className="flex flex-[0.75] md:flex-1 justify-center items-center border-white overflow-hidden h-[460px] md:w-auto"   variants={imageAnimate}
             >
            <img
              src={robot}
              alt="Robot"
          ...
          <div className="container flex  items-center flex-col md:gap-4 w-full md:w-auto h-[460px]" >
            <motion.h2 className="mt-[2px] font-bold text-center md:text-[60px] text-[40px] text-white undefined" variants={textAnimate}>
              {item?.heading}
            </motion.h2>
            <motion.div className="container flex flex-col items-center gap-2 md:gap-2 my-2 font-normal text-[17px] text-yellow-200" variants={textAnimate}>
              <ul>
                <li>{item?.p1}</li>
                <li>{item?.p2}</li>
                <li>{item?.p3}</li>
      ...
      {index === 4 && (
        <motion.div className="container w-full flex overflow-hidden relative px-2 py-12 md:flex-row flex-col flex-wrap gap-3 md:gap-2 items-center"
        initial={"offscreen"} whileInView={"onscreen"} viewport={{once:false}} transition={{staggerChildren:0.5}}>
