...
import { currentYearPartner } from '../../assets/partner'

const CurrCol = () => {
    return (
        <div>
            <h2 className='w-full my-4 text-3xl italic font-bold text-center'>Collaborators & Mentoring Partners</h2>
            <div className="w-40 h-1 mx-auto mb-4 -mt-4 text-gray-100 bg-gray-100 rounded" ></div>
            <div className='flex flex-wrap justify-center gap-5'>
                {
                    currentYearPartner.map((item, index) => (
