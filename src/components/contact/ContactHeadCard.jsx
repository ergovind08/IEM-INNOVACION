...
const ContactHeadCard = ({ content }) => {
    return (
        <div
            className="relative rounded-lg -skew-x-6 -translate-y-2 -translate-y-6 hover:-translate-y-1 hover:-translate-x-0 hover:skew-x-0 duration-500 p-2 bg-neutral-50 card-compact hover:bg-base-200 transition-all duration-200 [box-shadow:12px_12px] hover:[box-shadow:4px_4px] border-2 border-gray-900 my-4"
        >
            <figure className="w-full h-full ">
                <div
                    className="min-h-fit border-2 border-red-500 rounded-lg bg-[#000] text-neutral-50 border-opacity-5 flex items-center gap-3"
                >
                    <div className=''>
