...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="py-6 text-white bg-[#010525] h-[400px] sm:h-[300px] w-screen flex sm:justify-evenly"
    >
      <div className="flex sm:flex-row flex-col sm:justify-around w-full justify-between px-4 sm:px-0 sm:gap-10 h-fit">
        <div className="flex gap-5 justify-evenly sm:w-[40%]">
          ...
          <div className="flex flex-col gap-3 text-left w-[60%] sm:w-auto ">
            <h3 className=" text-[18px] sm:text-2xl font-bold w-full ">
              Quick links
            </h3>
            <div className="flex flex-col gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="relative flex items-center justify-center py-1 overflow-hidden font-medium duration-500 bg-gray-500 rounded-md cursor-pointer hover:border-gray-600 group text-sky-50"
              >
